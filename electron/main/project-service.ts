...
import { NotebookService, normalizeNotebookFromSnapshot } from './notebook-service'
...
export class ProjectService {
  ...
  private replaceWithSnapshot(rawSnapshot: ProjectSnapshot) {
    ...
    const replace = db.transaction(() => {
      ...
      this.ensureRepositories().notebook.update(normalizeNotebookFromSnapshot(snapshot.notebook))
