    ...
    this.db
      .prepare(`
        UPDATE scenes SET
          ...
          shoot_day_place = @shootDayPlace,
          shoot_day_production = @shootDayProduction,
          shoot_day_director = @shootDayDirector,
          shoot_day_photographer = @shootDayPhotographer,
          shoot_day_participants = @shootDayParticipants,
          shoot_day_folder_name = @shootDayFolderName,
          shoot_day_file_name = @shootDayFileName,
          shoot_day_clip_count = @shootDayClipCount,
          shoot_day_description = @shootDayDescription,
          shoot_day_strongest_material = @shootDayStrongestMaterial,
          shoot_day_follow_up = @shootDayFollowUp,
          notes = @notes,
    ...
    const row = this.db
      .prepare(`
        SELECT
          ...
          shoot_day_production AS shootDayProduction,
          shoot_day_director AS shootDayDirector,
          shoot_day_photographer AS shootDayPhotographer,
          shoot_day_participants AS shootDayParticipants,
          shoot_day_folder_name AS shootDayFolderName,
          shoot_day_file_name AS shootDayFileName,
          shoot_day_clip_count AS shootDayClipCount,
          shoot_day_description AS shootDayDescription,
          shoot_day_strongest_material AS shootDayStrongestMaterial,
          shoot_day_follow_up AS shootDayFollowUp,
          notes,
