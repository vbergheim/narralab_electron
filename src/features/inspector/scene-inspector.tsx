...
import { TranscriptViewerPanel } from '@/features/transcribe/components/transcript-viewer-panel'
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-4">
        ...
        <InspectorSection title="Scene Log">
          ...
          <MetaGrid>
            ...
            <InspectorField label="Actual length (min)" compact>
              <Input
                type="number"
                min={0}
                step="0.5"
    ...
    {previewTranscription && typeof document !== 'undefined'
      ? createPortal(
          ...
          >
            ...
            >
              <div className="h-[min(84vh,860px)] w-full max-w-5xl min-h-0">
                  ...
                  toolbarActions={
                    <>
                      <Button
                        ...
                        size="sm"
                        onClick={async () => {
                          const context = await window.narralab.windows.getContext()
                          ...
                          await window.narralab.windows.focusMainWindow()
